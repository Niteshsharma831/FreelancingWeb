...
import { FiTrendingUp, FiBookmark, FiShare2, FiEye } from "react-icons/fi";
        ...
        {open && (
          ...
          >
            ...
            {selectedValues.length > 0 && (
              <button
                type="button"
                onClick={() => onToggle(field, null, true)}
...
const InternshipPage = () => {
  ...
  useEffect(() => {
    ...
    resetAndFetch();
  }, [filters, searchQuery, fetchServerPage]);
  ...
  const clientFiltered = useMemo(() => {
    let filtered = internships.filter((job) => {
      ...
      return locOk && durOk && expOk && skillOk && typeOk && searchOk;
    });
    ...
    if (sortBy === "latest") {
      ...
      filtered.sort((a, b) => (b.stipend || 0) - (a.stipend || 0));
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-8 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-blue-100 mb-6 max-w-2xl">
            Discover thousands of internships from top companies. Gain
            real-world experience and kickstart your career.
          </p>
        ...
        <div className="hidden lg:block lg:w-1/4 xl:w-1/5 pr-6">
          ...
          <div className="mt-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                <span className="text-gray-600">PPO Offered</span>
          ...
          {pagedInternships.length > 0 && (
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="text-gray-600">
                Showing {start + 1} to {Math.min(end, clientFiltered.length)} of{" "}
                {clientFiltered.length} internships
              </div>
