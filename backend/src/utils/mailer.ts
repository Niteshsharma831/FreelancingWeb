...
export const isEmailConfigured = (): boolean => {
  ...
  console.log(
    `   EMAIL_PASS: ${cleanPass ? "✅ SET (length: " + cleanPass.length + ")" : "❌ NOT SET"}`,
  );
  console.log(
    `   Result: ${isConfigured ? "✅ CONFIGURED" : "❌ NOT CONFIGURED"}`,
  );
